...
@section('content')
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Welcome {{ Auth::user()->name }} {{ __('You are logged in!') }}</h4>
                        ...
                        <div class="panel-body">
                            <div class="inbox-widget nicescroll mx-box">
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-1.jpg ') }}" class="img-circle"
                                                alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-2.jpg ') }}" class="img-circle"
                                                alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-3.jpg ') }}" class="img-circle"
                                                alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-4.jpg ') }}" class="img-circle"
                                                alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-5.jpg ') }}" class="img-circle"
                                                alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-6.jpg ') }}" class="img-circle"
                                                alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-8.jpg ') }}" class="img-circle"
                                                alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img
                                                src="{{ asset('backend/images/users/avatar-9.jpg ') }}" class="img-circle"
                                                alt=""></div>
