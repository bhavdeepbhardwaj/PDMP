                                    ...
                                    <tbody>
                                        @foreach ($portName as $key => $value)
                                            @php
                                                ...
                                                // State ID
                                                $portState = \App\Models\State::where('id', $value['state_id'])
                                                    ->select('name')
                                                    ->first();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($portState)
                                                        {{ $portState->name ?? 'Name not available' }}
                                                    @else
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($portStateBoard)
                                                        {{ $portStateBoard->name ?? 'Name not available' }}
                                                    @else
                                                    @endif
                                                ...
                                                <td>
                                                    <strong>{{ $portCat->category_name }}</strong>
                                                    ...
                                                    <td class="actions">
                                                        ...
                                                        @if ($permissionData->edit == 1)
                                                            <a href="javascript:void(0)" data-toggle="modal"
                                                                data-target="#editmodal-xl" class="edit-data"
                                                                data-dataid="{{ $value['id'] }}"><i class="far fa-edit"
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control editPortData"
                                                    name="port_data_code" id="editPortData">
                                                <span class="invalid-feedback port_data-err" role="alert"
                                                    id="port_data-err"></span>
                                            </td>
                                        </tr>
