                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('addNationalWaterwaysInformation') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        @foreach ($getData as $value)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $value['cargo_moved'] }}</td>
                                                <td><a
                                                        href="{{ route('editNationalWaterwaysInformation', $value['id']) }}">
