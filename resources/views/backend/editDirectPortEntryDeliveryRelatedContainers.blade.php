    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Edit Direct Port Entry / Delivery Related Containers</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Edit Direct Port Entry / Delivery Related Containers</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Direct Port Entry Delivery Related Containers</h3>
                    </div>
                    <div class="card-body">
                        {{-- Form Respone --}}
                        @include('backend.component.flush')

                        <form method="POST" action="{{ route('updateDirectPortEntryDeliveryRelatedContainers', $editData->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('containers') is-invalid @enderror"
                                            name="containers" id="containers" placeholder="Enter Containers"
                                             value="{{ $editData['containers'] }}">
                                        @error('containers')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control @error('direct_port_entry_of_teu') is-invalid @enderror"
                                            id="direct_port_entry_of_teu" placeholder="Enter Direct Port Entry of Teu (No)"
                                            name="direct_port_entry_of_teu" value="{{ $editData['direct_port_entry_of_teu'] }}" >
                                        @error('direct_port_entry_of_teu')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="direct_port_delivery">Direct Port Delivery (No) <span
                                                style="color: red;">*</span></label>
                                        <input type="text"
                                            class="form-control @error('direct_port_delivery') is-invalid @enderror"
                                            id="direct_port_delivery" placeholder="Enter Direct Port Delivery (No)"
                                            name="direct_port_delivery" value="{{ $editData['direct_port_delivery'] }}">
                                        @error('direct_port_delivery')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
