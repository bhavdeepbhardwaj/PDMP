                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('addCruiseTourism') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $value['no_of_cruise_passengers'] }}</td>
                                                <td>{{ $value['cruise_berth_charges'] }}</td>
                                                <td><a href="{{ route('editCruiseTourism', $value['id']) }}" >
